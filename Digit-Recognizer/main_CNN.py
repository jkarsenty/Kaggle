...
''' Nous allons ici realiser un modele CNN de reconnaissance visuelle
...
from train import traitement_data, cnn_model, entrainement
...
# on utilise la fonction traitement_data pour normaliser nos data x_train
# et encoder les y_train pour avoir une distribution de proba sur les classes
...
model1 = cnn_model(outp1) # notre instance du modele
model1.summary()
